...
/// </summary>
public class AnimationRule_copy
{
    ...
    public AnimationRule_copy()
    {
        objNames = new List<string>();
    }
    public AnimationRule_copy(List<string> list)
    {
        objNames = new List<string>(list);
    }
}

public class MeshRaycast_copy : MonoBehaviour
{
    Camera cam;
            ...
            if (Input.GetMouseButtonDown(0))
            {
                switch (markerType)
                {
                    case 0:
                        ...
                        meshParser.FillHighlight(mesh, hlt_list, Color.cyan);
                        break;
                    case 1:
