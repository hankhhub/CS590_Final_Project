...
public class SaveFunction_Authoring : MonoBehaviour
{
    public Button load, save, saveall;
    public InputField animation, value;
    public Dropdown functionDropdown, objectDropdown;
  ...
  /*  public void onAnimationDropdownCilck()
        ...
        if (EventSystem.current.currentSelectedGameObject.name == "Animation")
        {
            ...
            switch (SelectObject.combinationName)
            {
                ...
                case "Belt and Pulley":
                    ...
                    break;
                case "Transmission":
                    CustomFunction_Transmission.combination_name = SelectObject.combinationName;
                    CustomFunction_Transmission.Animation_name = animation.text;
                    break;
            }
        }
        else if (EventSystem.current.currentSelectedGameObject.name == "Value")
        {
            switch (SelectObject.combinationName)
            {
                ...
                case "Transmission":
                    ...
                    {
                        case "speed1":
                            CustomFunction_Transmission.speed1 = value.text;
                            break;
                        case "speed2":
                            CustomFunction_Transmission.speed2 = value.text;
                            break;
                    }
                    break;
            }           
    ...
    void PopulateDropdown(Dropdown dropdown)
    {
        ...
        else if (dropdown.name == "AnimationDropdown")
        {
            ...
            var path = "C:/Users/user/Desktop/CS590/CS590_FinalProject/CS590_Final_Project/Assets/Resources";
            var fileName = "";
            switch (SelectObject.combinationName)
            {
                case "Screw_Nut_Interaction":
